...
from authenticfeet.actions import CloseSpiderAction
...
class SpiderCloseMonitorSuite(MonitorSuite):
    monitors = [SkuValidationMonitor, ItemCountMonitor, FinishReasonMonitor, UnwantedHTTPCodesMonitor, PeriodicJobStatsMonitor]
